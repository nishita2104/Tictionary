...
import 'package:tictionary/selection_screen.dart';
...
class TranslatePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Tictionary',
      home: TranslateHomePage(),
    );
  }
}

class TranslateHomePage extends StatefulWidget {
  TranslateHomePage({Key? key}) : super(key: key);
...
class _TranslateHomePageState extends State<TranslateHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    Container(width: 10,),
    Center(child: Text('Translate',style: TextStyle(fontSize: 25.0),textAlign: TextAlign.center,),),
    Container(width: 230,),
  ],
